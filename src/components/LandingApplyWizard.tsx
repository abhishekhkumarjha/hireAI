    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 font-sans selection:bg-indigo-500 selection:text-white relative overflow-hidden">
      ...
      <div className="p-6 rounded-3xl bg-slate-900 border border-slate-800 shadow-xl relative overflow-hidden flex flex-col md:flex-row md:items-center justify-between gap-6">
        ...
        <div className="space-y-2">
          ...
          {activeBootcamp.courseInfo && <p className="text-[10px] text-cyan-300/80">{activeBootcamp.courseInfo.duration} · {activeBootcamp.courseInfo.schedule} · India: {activeBootcamp.courseInfo.regionalPricing.India}</p>}
        </div>
                    ...
                    {antiCheatViolated ? (
                      ...
                      <div className="text-center py-6 space-y-4 animate-fade-in">
                        ...
                        <p className="text-xs text-slate-400 max-w-sm mx-auto">
                          Your proctored test results have been saved. Launch the **AI Chat Admissions Interview** to finalize step 4 evaluation.
                        </p>
                        <button
